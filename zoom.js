...
function zoomIcons()
{
  ...
  document.getElementById("arrow18").style.top = "10px";
  document.getElementById("arrow18").style.left = "1320px";
  ...
  document.getElementById("arrow20").style.top = "10px";
  document.getElementById("arrow20").style.left = "970px";
...
function zoomOutIcons()
{
  ...
  document.getElementById("arrow18").style.top = "15px";
  document.getElementById("arrow18").style.left = "860px";
  ...
  document.getElementById("arrow20").style.top = "15px";
  document.getElementById("arrow20").style.left = "635px";
